...
public:
    ...
    int addImportedBundle(const std::string& id, const std::string& pkg, const std::string& version,
                          const std::string& manifest_hash, const std::string& status);
    ...
    int addBlockedVersion(const std::string& pkg, const std::string& version,
    ...
    int setBundleStatus(const std::string& pkg, const std::string& version,
